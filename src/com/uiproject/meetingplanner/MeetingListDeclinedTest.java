...
public class MeetingListDeclinedTest extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final ArrayAdapter<MeetingInstance> adapter = new MeetingListArrayAdapter(this, R.layout.all_list_item, meetings, MeetingListArrayAdapter.LISTTYPE_DECLINED, uid);
	...
	public void onStart(){
		...
		ArrayAdapter<MeetingInstance> adapter = new MeetingListArrayAdapter(this, R.layout.all_list_item, meetings, MeetingListArrayAdapter.LISTTYPE_DECLINED, uid);
